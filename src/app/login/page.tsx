...
const I = {
  ...
  Quote: () => <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" opacity="0.15"><path d="M11 7H7a4 4 0 00-4 4v1a3 3 0 003 3h1a2 2 0 002-2V7zm10 0h-4a4 4 0 00-4 4v1a3 3 0 003 3h1a2 2 0 002-2V7z"/></svg>,
...
function TypingCode() {
  ...
  return (
    <div className="rounded-xl border border-white/[0.06] bg-[#0a0a12]/80 overflow-hidden backdrop-blur-sm">
      {/* Title bar */}
  ...
  return (
    <div>
      ...
      <div className="relative">
        {f && !error && (
          <div className="absolute -inset-[1px] rounded-xl bg-gradient-to-r from-indigo-500/20 via-violet-500/10 to-indigo-500/20 pointer-events-none" />
        )}
...
// ═══════════════════════════════════════════════════════════════════════════════════
// MAIN PAGE — Centered Card Design
// ═══════════════════════════════════════════════════════════════════════════════════
export default function LoginPage() {
  ...
  const rx = useTransform(my, [-300, 300], [3, -3])
  const ry = useTransform(mx, [-300, 300], [-3, 3])
